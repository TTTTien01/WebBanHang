            ...
            <div class="box-item">
                <h1 class="title">Thông tin đặt hàng</h1>  
                   ...
                   <div class="box-item">
                    ...
                    <div class="box-item">
                        <asp:TextBox ID="txtdc" class="control" placeholder="Địa chỉ giao hàng" runat="server"></asp:TextBox>
                    </div>
                    <div class="box-item">
                    <asp:TextBox ID="txtnoidung" class="control" runat="server" Height="74px" Width="300px" placeholder="Ghi chú"></asp:TextBox>
                    </div>
                     <div class="box-item">
