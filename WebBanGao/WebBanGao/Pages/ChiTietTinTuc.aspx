<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="ChiTietTinTuc.aspx.cs" Inherits="WebBanGao.Pages.ChiTietTinTuc" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <uc1:ChiTietTinTuc ID="ChiTietTinTuc1" runat="server" />
        ...
        <div class="adv"> 
            <div class="right">
                <div class="block">
                    <asp:Label runat="server" ID="TieuDeTT" ></asp:Label>
                    ...
                    <div class="content">
                        <asp:Label runat="server" ID="NoidungTT" style="text-align: justify;"></asp:Label>
                    </div>
                    <asp:Image runat="server" ID="imgTT" width="500px" height="250px"/>
                </div>
            </div>
        </div>
